            ...
            <div className="min-h-screen">
                <div className="mt-8 grid grid-cols-3 gap-4 h-screen p-6">
                    <div 
                        ...
                        <button className="font-bold text-center text-white mx-6 py-2 px-4 hover:bg-blue-500 bg-blue-400 
                         absolute bottom-4 left-0 rounded-full">Current Case Study</button>
                        <button className="font-bold text-center text-white mx-6 my-6 py-2 px-4 hover:bg-green-500 bg-green-400 
                        w-full absolute bottom-12 left-0 rounded-full">+ Add Case Study</button>
                    </div>
